  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          "quote-requested": "hsl(var(--status-quote-requested))",
          "quote-sent": "hsl(var(--status-quote-sent))",
          confirmed: "hsl(var(--status-confirmed))",
          "payment-pending": "hsl(var(--status-payment-pending))",
          paid: "hsl(var(--status-paid))",
          processing: "hsl(var(--status-processing))",
          packed: "hsl(var(--status-packed))",
